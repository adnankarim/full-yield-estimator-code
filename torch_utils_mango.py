...
print(DEVICE)
MODEL_PATH='best_model-mango.pth'
...
def get_prediction_mango (unique_id):
    #model path
    # input image
    input_image='1.jpg'
    #folders
    INPUT_IMAGE_DIR='mango/'+unique_id+'/INPUT_IMAGE'
    INPUT_IMAGE_PATCHES_DIR='mango/'+unique_id+'/INPUT_IMAGE_PATCHES'
    OUTPUT_IMAGE_PATCHES_PREDS='mango/'+unique_id+'/OUTPUT_IMAGE_PATCHES_PREDS'
    OUTPUT_HORIZONTAL_PATCHES_DIR='mango/'+unique_id+'/OUTPUT_HORIZONTAL_PATCHES'
    OUTPUT_IMAGE_DIR='mango/'+unique_id+'/OUTPUT_IMAGE'
